#!/usr/bin/env python3
"""
Create custom charts with Lovelo Bold font and specified color gradient
"""
...
def create_fan_engagement_chart():
    ...
    fig = go.Figure(data=[
        go.Bar(
            ...
            textposition='auto',
            textfont=dict(size=16, family='Lovelo Bold', color='#2c3e50')
        )
    ])
    ...
    fig.update_layout(
        title=dict(
            ...
            font=dict(size=24, family='Lovelo Bold', color='#2c3e50'),
            x=0.5
        ),
        xaxis=dict(
            title=dict(text='Age Group', font=dict(size=18, family='Lovelo Bold', color='#2c3e50')),
            tickfont=dict(size=14, family='Lovelo Bold', color='#2c3e50')
        ),
        yaxis=dict(
            title=dict(text='Total Games Attended', font=dict(size=18, family='Lovelo Bold', color='#2c3e50')),
            tickfont=dict(size=14, family='Lovelo Bold', color='#2c3e50')
        ),
        plot_bgcolor='#f5f8ff',
        paper_bgcolor='#f5f8ff',
        font=dict(family='Lovelo Bold', size=14, color='#2c3e50'),
...
def create_revenue_composition_chart():
    ...
    fig.update_layout(
        ...
        showlegend=True,
        legend=dict(
            font=dict(size=16, family='Lovelo Bold', color='#2c3e50'),
            x=0.5,
            y=-0.1,
            orientation='h'
        )
...
def create_stadium_sources_chart():
    ...
    fig = go.Figure(data=[
        go.Bar(
            ...
            textposition='auto',
            textfont=dict(size=14, family='Lovelo Bold', color='#2c3e50')
        )
    ])
    ...
    fig.update_layout(
        ...
        xaxis=dict(
            ...
            title=dict(text='', font=dict(size=18, family='Lovelo Bold', color='#2c3e50')),
            tickfont=dict(size=12, family='Lovelo Bold', color='#2c3e50')
        ),
        yaxis=dict(
            title='Revenue ($)',
            title=dict(text='', font=dict(size=18, family='Lovelo Bold', color='#2c3e50')),
...
def create_merchandise_categories_chart():
    ...
    fig = go.Figure(data=[
        go.Bar(
            ...
            text=[f'${x:,.0f}' for x in revenues],
            textposition='auto',
            textfont=dict(size=12, family='Lovelo Bold', color='#2c3e50')
        )
    ])
...
if __name__ == "__main__":
    print("Creating custom charts with Lovelo Bold font and #84a9ff to #f5f8ff gradient...")
