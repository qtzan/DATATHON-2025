#!/usr/bin/env python3
"""
Create working custom charts with specified color gradient
"""
...
def create_fan_engagement_chart():
    ...
    # Data
    age_groups = ['<18', '18-25', '26-40', '41-60', '60+']
    total_games = [40117, 178073, 101472, 60499, 19638]
