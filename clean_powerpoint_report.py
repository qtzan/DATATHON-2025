#!/usr/bin/env python3
"""
Vancouver City FC - Clean PowerPoint Report
Uses clean static chart images instead of interactive charts
"""
...
def create_clean_powerpoint_report():
    """Create a PowerPoint-style presentation with clean chart images"""
    ...
    <head>
        ...
        <style>
            ...
            * {{
            ...
            .slide-content.full-width .slide-text {{
                max-width: 1200px;
                margin: 0 auto;
                padding: 40px;
            }}
            
            .slide-content.full-width .constraint-box,
            .slide-content.full-width .recommendation-box,
            .slide-content.full-width .highlight-box {{
                margin: 30px 0;
                padding: 30px;
            }}
            
            .slide-content.full-width .subsection-title {{
                font-size: 1.8em;
                margin: 25px 0 20px 0;
            }}
            
            .slide-content.full-width p {{
                font-size: 1.2em;
                line-height: 1.8;
                margin: 20px 0;
            }}
            
            .slide-content.full-width li {{
                font-size: 1.2em;
                line-height: 1.8;
                margin: 12px 0;
            }}
            ...
            <div class="slide">
                ...
                <div class="slide-content">
                    ...
                    <div class="slide-chart">
                        ...
                        <img src="revenue_composition.png" alt="Revenue Composition Chart" class="chart-image">
                    </div>
                </div>
            </div>
            ...
            <div class="slide">
                ...
                <div class="slide-content">
                    ...
                    <div class="slide-chart">
                        ...
                        <img src="monthly_trends.png" alt="Monthly Revenue Trends" class="chart-image">
                    </div>
                </div>
            </div>
            ...
            <div class="slide">
                ...
                <div class="slide-content">
                    ...
                    <div class="slide-chart">
                        ...
                        <img src="fan_age_groups.png" alt="Games Attended by Age Group" class="chart-image">
                    </div>
                </div>
            </div>
            ...
            <div class="slide">
                ...
                <div class="slide-content">
                    ...
                    <div class="slide-chart">
                        ...
                        <img src="merchandise_category.png" alt="Revenue by Category" class="chart-image">
                    </div>
                </div>
            </div>
            
            <!-- Slide 5b: Channel Performance -->
            <div class="slide">
                <div class="slide-header">
                    <h1>MERCHANDISE CHANNELS</h1>
                </div>
                <div class="slide-content">
                    <div class="slide-text">
                        <div class="subsection-title">CHANNEL ANALYSIS</div>
                        <p>Online and in-store channels show different performance patterns with distinct 
                        customer behaviors and revenue contributions.</p>
                        
                        <div class="highlight-box">
                            <div class="subsection-title">CHANNEL INSIGHTS</div>
                            <ul>
                                <li>Online: Higher volume, lower average price</li>
                                <li>In-Store: Premium pricing, personal service</li>
                                <li>Channel optimization opportunities</li>
                            </ul>
                        </div>
                    </div>
                    <div class="slide-chart">
                        <div class="chart-title">Channel Performance</div>
                        <img src="merchandise_channel.png" alt="Channel Performance" class="chart-image">
                    </div>
                </div>
            </div>
            
            <!-- Slide 5c: Promotion Impact -->
            <div class="slide">
                <div class="slide-header">
                    <h1>PROMOTION IMPACT</h1>
                </div>
                <div class="slide-content">
                    <div class="slide-text">
                        <div class="subsection-title">PROMOTIONAL EFFECTIVENESS</div>
                        <p>Promotional campaigns show significant impact on merchandise sales, with clear 
                        revenue differences between promoted and non-promoted items.</p>
                        
                        <div class="highlight-box">
                            <div class="subsection-title">PROMOTION INSIGHTS</div>
                            <ul>
                                <li>Promotions drive significant revenue</li>
                                <li>Strategic timing opportunities</li>
                                <li>Customer response patterns</li>
                            </ul>
                        </div>
                    </div>
                    <div class="slide-chart">
                        <div class="chart-title">Promotion Impact</div>
                        <img src="merchandise_promotion.png" alt="Promotion Impact" class="chart-image">
                    </div>
                </div>
            </div>
    ...
    # Save HTML file
    with open('vancouver_city_fc_clean_powerpoint.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✓ Clean PowerPoint report created: vancouver_city_fc_clean_powerpoint.html")
    print("✓ Uses clean static chart images instead of messy interactive charts")
    print("✓ Professional, readable charts with dark theme")
    print("✓ 9 slides with navigation controls")
    print("✓ Charts are now clean, static images that look professional")

if __name__ == "__main__":
    create_clean_powerpoint_report()
