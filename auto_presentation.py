#!/usr/bin/env python3
"""
Vancouver City FC - Automatic Presentation
Runs all slides automatically without user input
"""
...
class VancouverCityFCAutoPresentation:
    def __init__(self):
    ...
    def slide_1_title_slide(self):
        ...
        time.sleep(2)  # Wait 2 seconds before next slide
    ...
    def slide_2_question_1_revenue_strategies(self):
        ...
        time.sleep(3)  # Wait 3 seconds before next slide
    ...
    def run_presentation(self):
        """Run the complete presentation automatically"""
        print("🏟️ VANCOUVER CITY FC - AUTOMATIC PRESENTATION 🏟️")
        print("="*80)
...
if __name__ == "__main__":
    presentation = VancouverCityFCAutoPresentation()
